...
a = 10
b = 5
print("Addition of a,b is", a + b) # 15
print("Subtraction of a,b is", a - b) # 5
print("Multiplication of a,b is", a * b) # 50
print("Division of a,b is", a / b) # 2
print("Modulus of a,b is", a % b) # 0
print("floor division of a,b is", a // b) # 2
print("Exponentiation of a,b is", a ** b) # 100000
...
## ** Membership Operators **# Membership Operators Example
numbers = [1, 2, 3, 4, 5]
text = "Hello, Python!"
